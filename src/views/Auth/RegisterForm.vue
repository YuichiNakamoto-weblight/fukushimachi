<!-- src/views/Auth/RegisterForm.vue ※未使用？-->
<template>
  <div class="wrap" :class="[{ 'is-employer': defaultUserType==='employer', 'is-guest': true }, pageSlug]">
    ...
    <main>
      <section class="l-sec signup-detail">
        ...
        <!-- ワイヤー上部タイトル -->
        <div class="page-title maru">アカウント登録</div>
          ...
          <div class="inner">
            <form action="javascript:void(0)" method="post" class="form" @submit.prevent="onSubmit" novalidate>
              <div class="form-items">
                ...
                <!-- パスワード -->
                <div class="form-item field password-field" :data-visible="pw1Visible">
...
async function onSubmit () {
  ...
  const payload = {
    ...
    user_type: props.defaultUserType,
  }
...
input[type="password"] {
  ...
  border: 2px solid #333; /* ワイヤーの濃い枠線 */
  border-radius: 0;        /* ワイヤーに合わせ角丸なし */
  background: #fff;
}
