<!-- src/views/settings/BizNoticeIndex.vue -->
<!-- 事業者：お知らせ機能（一覧） -->
<template>
  <body class="setting-notice is-employer is-login">
    <div class="wrap">
      ...
      <main>
        ...
        <div class="inner">
          <div class="user-list__activity">
            <ul>
              <li @click="$router.push({ name: 'BizNoticeEmail' })">
                <a>メール通知
                  <span class="ico-arrow02">
                    <img src="/src/assets/images/common/ico-arrow02.svg" alt="">
                  </span>
                </a>
              </li>
              <li @click="$router.push({ name: 'BizNoticePush' })">
                <a>プッシュ通知
                  <span class="ico-arrow02">
                    <img src="/src/assets/images/common/ico-arrow02.svg" alt="">
                  </span>
